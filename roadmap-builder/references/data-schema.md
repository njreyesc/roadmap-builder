...
| `feature_flags` | нет | Флажки старта/финиша у каждой фичи (синий шест+вымпел на левом крае первой полосы фичи, красный — на правом крае последней). По умолчанию `true`; `false` — не рисовать |
